...
import { listEventsPage } from "@/server/application/events";
...
export default async function AdminEventsPage({
  ...
  const result = await listEventsPage(container.eventRepository, { page });
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {data === null ? (
        ...
        <>
          <p className="text-muted-foreground text-sm">
            {data.total} {data.total === 1 ? "ročník" : "ročníků"} celkem
          </p>
